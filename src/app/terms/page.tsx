          ...
          <div className="lg:col-span-8 space-y-12 bg-white border border-slate-200/60 rounded-3xl p-8 md:p-10 shadow-sm">
            ...
            <div id="acceptance" className="scroll-mt-24">
              ...
              <p className="text-xs leading-relaxed text-slate-600">
                By viewing or utilizing the website of Eveda Online Services, or signing quotation contracts generated by our team, you declare full compliance with these Terms of Service. If you disagree with any specific legal bounds, please exit our platform.
              </p>
            </div>
            ...
            <div id="services-scope" className="scroll-mt-24 border-t border-slate-100 pt-8">
              ...
              <p className="text-xs leading-relaxed text-slate-600">
                Eveda Online Services specializes in custom web development, mobile applications, SaaS platform development, data analytics architectures, cloud migration, and AI automation software. Scope definitions, targets, and delivery schedules will be formally managed in individual Statements of Work (SOWs).
              </p>
            </div>
            ...
            <div id="intellectual-property" className="scroll-mt-24 border-t border-slate-100 pt-8">
              ...
              <p className="text-xs leading-relaxed text-slate-600">
                Unless stated otherwise in individual contracts, Eveda Online Services reserves all structural IP over our pre-existing code frameworks, library elements, and modules. Upon final project settlement, proprietary client code, custom layouts, and databases are assigned to the client.
              </p>
            </div>
            ...
            <div id="user-obligations" className="scroll-mt-24 border-t border-slate-100 pt-8">
              ...
              <p className="text-xs leading-relaxed text-slate-600">
                Clients must provide required API access keys, asset files, and text details promptly. Any delays caused by third-party vendor configurations outside our team&apos;s reach are not the responsibility of Eveda Online Services.
              </p>
            </div>
            ...
            <div id="liability-limits" className="scroll-mt-24 border-t border-slate-100 pt-8">
              ...
              <p className="text-xs leading-relaxed text-slate-600">
                Eveda Online Services is not liable for indirect, incidental, or special damages, including database loss, lost sales, or downtime incidents arising from server issues of hosting vendors like AWS or Azure.
              </p>
            </div>
            ...
            <div id="dispute-resolution" className="scroll-mt-24 border-t border-slate-100 pt-8">
              ...
              <p className="text-xs leading-relaxed text-slate-600">
                Disputes arising from this agreement will be settled through arbitration under the laws of Haridwar, Uttarakhand.
              </p>
            </div>
            ...
            <div id="contact-support" className="scroll-mt-24 border-t border-slate-100 pt-8">
              ...
              <p className="text-xs text-slate-805 font-bold leading-relaxed">
                ...
                Office Address: 53 eVeda Online Services Aryanagar, Haridwar, Uttarakhand
              </p>
            </div>
          </div>
