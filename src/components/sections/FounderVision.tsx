      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="absolute -top-4 -left-4 w-40 h-40 bg-gradient-to-br from-purple-200/40 to-indigo-100/30 rounded-3xl -z-10 blur-sm hidden sm:block" />
            ...
            <div className="relative rounded-[32px] overflow-hidden border border-white/80 bg-gradient-to-b from-white/90 to-purple-50/50 backdrop-blur-2xl shadow-[0_24px_60px_-15px_rgba(124,58,237,0.18)] p-3.5 sm:p-4 group">
              <div className="relative aspect-[3/4] w-full rounded-[24px] overflow-hidden bg-slate-900 shadow-inner">
                <Image
                  ...
                  alt="Geetanjali Singh — Founder & Visionary, E Veda Online Services"
                  fill
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-[11px] font-black uppercase tracking-wider text-[#7C3AED] bg-purple-50 border border-purple-200/60 mb-3 shadow-xs">
                ...
                <span>{isFull ? "The Vision Behind E Veda" : "Meet the Founder"}</span>
              </div>
              ...
              <p className="text-xs sm:text-sm font-extrabold text-slate-500 uppercase tracking-widest mt-2">
                Founder & Visionary — E Veda Online Services
              </p>
            </div>
            ...
            {isFull ? (
              <>
                <div className="space-y-4 text-slate-600 text-sm sm:text-base leading-relaxed">
                  <p>
                    Behind E Veda Online Services is <strong className="text-slate-900 font-bold">Geetanjali Singh</strong>, a founder driven by creativity, determination, and the belief that every business, professional, author, and idea deserves a strong digital presence.
                  </p>
                  <p>
                    With a vision to bring technology, creativity, publishing, design, and digital marketing together under one roof, Geetanjali established E Veda Online Services as a platform designed to help individuals and businesses turn their ideas into professionally crafted digital experiences.
                  </p>
                  <p>
              ...
              <div className="space-y-4 text-slate-600 text-sm sm:text-base leading-relaxed">
                <p>
                  Every meaningful venture begins with a vision. E Veda Online Services is the result of <strong className="text-slate-900 font-bold">Geetanjali Singh&apos;s</strong> vision to bring technology, creativity, publishing, and digital marketing together to help people and businesses build their presence with confidence.
                </p>
                <p>
                  With a strong focus on quality, creativity, and client-focused solutions, she continues to build E Veda as a trusted partner for businesses, authors, publishers, professionals, and entrepreneurs.
                </p>
            ...
            <div className="pt-3">
              {isFull ? (
                ...
                >
                  <span>Discover the E Veda Story</span>
