...
export default function GenericProductDetail({ product }: { product: ProductDetail }) {
  ...
  const testimonials = [
    {
      quote: `eVeda ${product.title} transformed how our team handles daily workflows. We scaled our operations 4x faster and maintain perfect data compliance. Truly the best system we have ever deployed.`,
      name: "Sarah Jenkins",
  ...
  return (
    <div className="min-h-screen text-[var(--text-secondary)] bg-[var(--bg-primary)] relative w-full max-w-full overflow-x-clip" style={customStyles}>
      ...
      <section className="py-20 sm:py-24 bg-white relative overflow-visible">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 relative overflow-visible">
          ...
          <div className="max-w-3xl mb-12 sm:mb-16">
            ...
            >
              Get Started with eVeda {product.title} <br />
      ...
      >
        <div className="bg-[var(--bg-surface)]/90 backdrop-blur-md border border-white/[0.08] rounded-2xl sm:rounded-full px-3.5 py-2.5 sm:px-5 sm:py-3 shadow-[0_15px_50px_rgba(0,0,0,0.3)] flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="sm:hidden text-[11px] font-bold text-white font-sora truncate max-w-[100px] shrink-0">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="bg-[var(--accent-global)] hover:bg-[var(--accent-global-hover)] text-white font-bold text-[10px] sm:text-xs px-3 sm:px-5 py-2 rounded-xl sm:rounded-full flex items-center gap-1 sm:gap-1.5 transition-all shadow-md shadow-[0_4px_12px_rgba(var(--accent-global-rgb),0.15)] cursor-pointer whitespace-nowrap"
            >
